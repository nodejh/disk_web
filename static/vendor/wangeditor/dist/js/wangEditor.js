...
_e(function (E, $) {
    ...
    Txt.fn.bindFormatText = function () {
        ...
        // 将 E.config.js.legalTags 配置的有效字符，生成正则表达式
...
_e(function (E, $) {
    ...
    // 自定义上传图片的filename
    // E.config.js.uploadImgFileName = 'customFileName';

    // 自定义上传，设置为 true 之后，显示上传图标
    E.config.customUpload = false;
    // 自定义上传的init事件
    // E.config.js.customUploadInit = function () {....};
    ...
    // 是否粘贴纯文本，当 editor.config.js.pasteFilter === false 时候，此配置将失效
    ...
    E.createMenu(function (check) {
        ...
        function insertEmotionImgs(data, $tabContent) {
            ...
            $.each(data, function (k, emotion) {
                ...
                // 通过配置 editor.config.js.emotionsShow 的值来修改插入到编辑器的内容（图片/value）
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        var editor = this;
        var fns = editor.config.uploadImgFns; // editor.config.js.uploadImgFns = {} 在config文件中定义了
